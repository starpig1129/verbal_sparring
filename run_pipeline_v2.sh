...
python training/train_dpo.py --epochs 3 --learning_rate 5e-5 --output_dir ./player_lora_output/player_agent_dpo
...
if [ -f "training/evaluate_benchmark.py" ]; then
    ...
    python training/evaluate_benchmark.py --adapter_path ./referee_lora_output/referee_agent_v2/referee_agent_v2/referee_agent_v2 || echo "   ⚠️ Referee evaluation encountered warnings, continuing..."
fi
